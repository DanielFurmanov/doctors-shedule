...
(function () {
	angular.service('doctorsApi', ['$http', function ($http) {
...
(function () {
	angular.module('doctorsScheduleApp', ['ngMaterial', 'doctorsApi']).controller('doctorsController', ['doctorsApi', doctorsController]);

	function doctorsController(doctorsApi) {
		$scope.doctors = [];
